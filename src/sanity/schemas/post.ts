...
export const postSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'igPending', title: 'Aguardando aprovação IG', type: 'boolean' }),
    defineField({ name: 'igCanvaDesignId', title: 'ID do design Canva (IG)', type: 'string' }),
    defineField({ name: 'igExportUrl', title: 'URL da imagem exportada (IG)', type: 'url' }),
    defineField({ name: 'igCaption', title: 'Legenda do post IG', type: 'text', rows: 5 }),
