  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-green-50 border border-green-200 rounded-2xl p-6 mt-8 text-center">
        ...
        <ButtonLink href="/contato" size="lg">Entrar em contato →</ButtonLink>
      </div>
          ...
          __html: JSON.stringify([
            {
              ...
              '@type': 'Person',
              name: 'Leonam Alves',
              url: 'https://portalendinheirados.com.br/autor',
              jobTitle: 'Editor-chefe',
              worksFor: { '@type': 'Organization', name: 'Endinheirados', url: 'https://portalendinheirados.com.br' },
            ...
            },
            {
              ...
              logo: 'https://portalendinheirados.com.br/logo-endinheirados.png',
              ...
              contactPoint: { '@type': 'ContactPoint', contactType: 'editorial', url: 'https://portalendinheirados.com.br/contato' },
            },
          ]),
        }}
      />
